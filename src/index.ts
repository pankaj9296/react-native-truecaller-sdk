...
export default {
  initializeClient: (options: TrueOptions): void => TruecallerAuthModule?.initializeClient(options),
  on: (event: string, callback: any) => EventEmitter.addListener(event, callback),
